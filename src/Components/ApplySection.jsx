...
const ApplySection = () => {
  return (
    <div className='px-5  pt-10 pb-24 lg:pt-16  lg:w-5/6 mx-auto relative lg:pointer-events-none h-full'>
      ...
      <div className='flex flex-col lg:flex-row mt-16 lg:mt-28 gap-10'>
